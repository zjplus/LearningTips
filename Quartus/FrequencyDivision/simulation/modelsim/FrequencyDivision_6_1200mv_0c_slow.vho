...
-- set	=>  Location: PIN_N6,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF FrequencyDivision097 IS
...
-- Equation(s):
-- \QI~2_combout\ = (QI(2) & ((!QI(1)))) # (!QI(2) & (QI(0) & QI(1)))
...
-- Equation(s):
-- \QI~1_combout\ = (QI(1) & (!QI(2) & !QI(0))) # (!QI(1) & ((QI(0))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (QI(1) & (!QI(0) & QI(2)))
