...
ARCHITECTURE structure OF counter097 IS
...
SIGNAL \QI~2_combout\ : std_logic;
SIGNAL \reset~input_o\ : std_logic;
SIGNAL \reset~inputclkctrl_outclk\ : std_logic;
SIGNAL \set~input_o\ : std_logic;
SIGNAL \QI~3_combout\ : std_logic;
SIGNAL \QI~1_combout\ : std_logic;
SIGNAL \QI~0_combout\ : std_logic;
...
\QI~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \QI~2_combout\ = (!QI(3) & (QI(2) $ (((QI(0) & QI(1))))))
...
\QI~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \QI~3_combout\ = (QI(0) & (QI(2) & (!QI(3) & QI(1)))) # (!QI(0) & (!QI(2) & (QI(3) & !QI(1))))
...
\QI~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \QI~1_combout\ = (!QI(3) & (QI(1) $ (QI(0))))
...
\QI~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \QI~0_combout\ = (!QI(0) & (((!QI(1) & !QI(2))) # (!QI(3))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (QI(0) & (QI(3) & (!QI(1) & !QI(2))))
